...
# number of frames in the video file
	...
	total = -1
cnt = 0 #IMP: Counter for skipping frames
...
while True:
	...
	# set a cnt, continue if cnt some multiple of some number; not want all frames, lot of processing power.
	# send frame to classifier, for detecting accident.
	# increment cnt, if MAX, reset cnt.
	start1 = time.time()
